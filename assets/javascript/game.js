...
$(document).ready(function () {
    ...
    var movieTitles = ["Star-Wars", "Jurassic-Park", "Avengers", "The-Incredibles", "Batman", "Finding-Nemo", "Finding-Dori", "Pirates-of-the-Caribbean", "The-Lion-King", "Toy-Story", "Wonder-Woman", "The-Hunger-Games", "Jumanji", "Titanic", "The-Sound-of-Music", "Alien", "Paranorman", "Coraline", "Wall-E", "Monsters-Inc", "Indiana-Jones-and-the-Raiders-of-the-Lost-Ark", "Indiana-Jones-and-the-Temple-of-Doom", "Indiana-Jones-nad-the-Last-Crusade", "Tron", "Tron-Legacy", "The-day-after-Tomorrow", "Edge-of-Tomorrow", "Mission-Impossible", "Star-Trek", "Bullitt", "Dirty-Harry", "The-Good,-the-Bad-and-the-Ugly", "The-Outlaw-Josey-Wales", "Pulp-Fiction", "Kill-Bill", "Enter-the-Dragon"];
    var puzzle;
    var wins;
    var losses;
    var guessCorrect = [];
    ...
    $("#resetBtn").on("click", function () {
        ...
        // reset = function () {
        //     remainingGuesses = 10;
        //     document.getElementById('remainingGuesses-text').innerHTML = remainingGuesses;
        // }
